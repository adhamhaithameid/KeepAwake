...
private let logger = Logger(subsystem: "com.adhamhaithameid.keepawake", category: "AppViewModel")
...
final class AppViewModel: ObservableObject {
    ...
    func handleAppTermination() {
        ...
        toastMessage = nil
        statusMessage = "KeepAwake closed."
    }
    ...
    private func showErrorToast(_ error: Error) {
        let message: String
        if let keepCleanError = error as? KeepAwakeError {
