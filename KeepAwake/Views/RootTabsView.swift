...
struct RootTabsView: View {
    ...
    private func tabButton(for tab: AppTab) -> some View {
        Button {
            ...
            .foregroundStyle(model.selectedTab == tab ? Color.white : KeepAwakePalette.ink)
    ...
    private func toastView(message: String, isError: Bool) -> some View {
        HStack(spacing: 10) {
            Image(systemName: isError ? "exclamationmark.triangle.fill" : "checkmark.circle.fill")
                ...
                .foregroundStyle(isError ? .red : KeepAwakePalette.success)
        ...
        .background {
            RoundedRectangle(cornerRadius: 10, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 10, style: .continuous)
                        .strokeBorder(
                            isError ? Color.red.opacity(0.3) : KeepAwakePalette.success.opacity(0.3),
                            lineWidth: 1
                        )
                }
